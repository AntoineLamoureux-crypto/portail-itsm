...
function FloatingLinkEditor({ editor }) {
  ...
  return (
    <Stack ref={editorRef} bg="white" color="black">
      {isEditMode ? (
        <Input
          ref={inputRef}
          value={linkUrl}
...
function BlockOptionsDropdownList({
  ...
  return (
    <Stack ref={dropDownRef} w="fit-content" overflowY="auto">
      ...
      {blockType === 'code' ? (
        ...
        <>
          <Button
            ...
            bg={
              isBold ? 'rgba(223, 232, 250, 0.3)' : 'rgba(223, 232, 250, 0.05)'
            }
          ...
          <Button
            ...
            bg={
              isCode ? 'rgba(223, 232, 250, 0.3)' : 'rgba(223, 232, 250, 0.05)'
            }
